...
# -*- coding: utf-8 -*-
"""
MobileNetV3Large — Multimodal training for Chinese Medicinal Herb classification.
Training strategy STRICTLY follows MNV2_text.py (MobileNetV2 multimodal baseline).

Architecture (identical to MNV2_text.py):
  Visual branch: MobileNetV3Large (224×224) → GAP → BN → Dense(512, swish)
...
def build_mobilenetv3_backbone(input_tensor=None):
    """Build MobileNetV3Large backbone, optionally with a specific input_tensor."""
...
OUTPUT_DIR = os.path.join(os.path.dirname(os.path.abspath(__file__)),
                          "output_mobilenetv3_multimodal")


if __name__ == "__main__":
    print("=" * 70)
    print("MobileNetV3Large MULTIMODAL Training")
    ...
    run_multimodal_cv(
        model_name="MobileNetV3Large_Multimodal",
